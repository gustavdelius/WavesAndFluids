...
## Introduction
The reason why waves are so fundamentally important is that waves are the way
information is propagating. Some waves that propagate information are obvious:
...
at you, this too is described by a wave, as you will learn in quantum mechanics.
...
special relativity. For example, we can look back into the past because some of
...
The string is sufficiently simple, that we can understand it by pure thought. We
...
&=T\cos\theta(x+\delta_x)-T\cos\theta(x)\\
