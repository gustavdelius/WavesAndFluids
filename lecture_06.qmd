...
that in turn is made up out of kinetic and potential energy density. We will
then calculate the energy in a few example waves, and then discuss the
...
$$ {#eq-energy1}
The quantity $\mathcal{E}_K$ is the kinetic energy density.
...
$$ {#eq-energy2}
The quantity $\mathcal{E}_V$ is the potential energy density.
...
where $\mathcal{E}=\mathcal{E}_K + \mathcal{E}_V$ is the total energy density.

## Energy density of example waves

::: {#exm-energy_travelling_wave}

Consider a localised wave $y=f(x-ct)$ travelling to the right with speed $c$.
...
time and are not equal. However, the averaged (over a period in $t$) kinetic and
potential energies are equal. The total energy is constant
$$
E=K+T
