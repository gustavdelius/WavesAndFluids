...
Harmonic waves are not localised in $x$. Instead they are periodic in $x$ and keep repeat infinitely. However, it is possible to construct a localised \emph{wave packet}
