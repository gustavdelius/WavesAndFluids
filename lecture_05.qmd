...
$$\begin{split}
y(x,t)&=a \cos\left(kx - \omega t + \phi\right) \\
&= {\rm Re}\left( a e^{i\phi} e^{i(kx-\omega t)}\right)\\
&={\rm Re}\left( A e^{i(kx-\omega t)}\right),
...
solution:
$$
{\rm Re}(y(x,t))=a\, e^{-pt/2} \cos\left[k\left(x \pm t \, \sqrt{c^2  - p^2/(4k^2)}\right)+\phi\right]
$$ {#eq-5.16}
